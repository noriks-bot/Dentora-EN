<?php
/**
 * Vitaria Oral front page (homepage).
...
$feat_img    = $img . 'ChatGPTImageFeb17_2026_01_54_46PM.png';
$life_img    = $img . 'ChatGPTImageFeb17_2026_01_56_29PM.png';
?>
...
<div class="hp">
  ...
  <section class="hp-hero-bg">
    <div class="hp-wrap hp-hero">
      <div class="hp-hero-text">
        <div class="hp-stars">★★★★★ <span>4.8/5 · 8,000+ happy families</span></div>
        <h1>A brighter, healthier smile for the whole family.</h1>
        <p class="lead">The Vitaria Oral™ 3-in-1 Oral Care Kit — everything you need for a clean, fresh, confident smile. Gentle enough for kids, effective for the whole family.</p>
        <div class="hp-cta-row">
          <a href="<?php echo esc_url( $product_url ); ?>" class="hp-btn hp-btn-primary">Shop the Kit</a>
          <a href="<?php echo esc_url( $shop_url ); ?>" class="hp-btn hp-btn-outline">Browse all</a>
        </div>
      </div>
      <div class="hp-hero-img">
        <img src="<?php echo esc_attr( $hero_img ); ?>" alt="Vitaria Oral 3-in-1 Kit" loading="eager">
      </div>
    </div>
  </section>
  ...
  <section class="hp-trust">
    <div class="hp-wrap hp-trust-grid">
      <div class="t-item"><strong>4.8★</strong>8,000+ reviews</div>
      <div class="t-item"><strong>30</strong>days risk-free</div>
  ...
  <section class="hp-feat">
    <div class="hp-wrap hp-feat-inner">
      <div class="hp-feat-img">
        <img src="<?php echo esc_attr( $feat_img ); ?>" alt="Vitaria Oral 3-in-1 Kit" loading="lazy">
      </div>
      <div class="hp-feat-text">
        <h2>Vitaria Oral™ 3-in-1 Oral Care Kit</h2>
        <ul>
          <li>3-in-1 system: brush, clean and freshen in one routine</li>
          <li>Gentle on gums — safe for kids and adults</li>
          <li>Helps remove plaque and brighten teeth</li>
          <li>Compact, travel-friendly, easy to use daily</li>
        </ul>
    ...
    <div class="hp-wrap">
      ...
      <div class="hp-rev-grid">
        <div class="hp-rev-card">
          <div class="stars">★★★★★</div>
          <p>"My kids actually look forward to brushing now. Their teeth look great."</p>
          <div class="name">— Sarah M.</div>
        </div>
        <div class="hp-rev-card">
          <div class="stars">★★★★★</div>
          <p>"Simple routine, real results. The whole family uses it."</p>
          <div class="name">— James K.</div>
        </div>
        <div class="hp-rev-card">
          <div class="stars">★★★★★</div>
          <p>"Noticeably whiter teeth after a few weeks. Highly recommend."</p>
  ...
  <section class="hp-final">
    <div class="hp-wrap">
      ...
      <p>Try Vitaria Oral risk-free for 30 days. Love it or your money back.</p>
