...
<body <?php body_class( 'dentora-body' ); ?>>

<?php wp_body_open(); ?>

<div id="page" class="dentora-site">
  ...
  <header class="cal-header" role="banner">
    <div class="cal-header-inner">
      ...
      <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="cal-logo" aria-label="Vitaria Oral">
        <span class="cal-logo-text">VITARIA ORAL</span>
      </a>
