<?php
/**
 * vitariaoral single product — serves the cloned product HTML for the main product.
...
$brand_live_src  = '/var/www/vitariaoral/en/static/site/products/3-in-1-dentora-kids-oral-kit.html';
...
if ( $brand_curr_id === $brand_clone_pid && file_exists( $brand_source ) ) {
    ...
    $html = preg_replace(
        array(
            '#<script[^>]*src="[^"]*cdn/shop/t/[0-9]+/assets/jquery[^"]*"[^>]*></script>#i',
